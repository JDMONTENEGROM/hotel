...
Route::group(['middleware' => ['auth', 'checkRole:Super,Admin']], function () {
    ...
    Route::prefix('check-in')->name('check-in.')->group(function () {
        ...
        Route::post('/store', [CheckInController::class, 'store'])->name('store');
        Route::get('/select-room/{customer}', [CheckInController::class, 'selectRoom'])->name('select-room');
        Route::get('/confirmation/{customer}/{room}', [CheckInController::class, 'confirmation'])->name('confirmation');
...
// Rutas sensibles solo para administradores (Super)
