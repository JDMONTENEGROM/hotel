$(function() {
                ...
                "render": function(typeId) {
                    return `
                        <button class="btn btn-light btn-sm rounded shadow-sm border"
                            ...
                            data-bs-toggle="tooltip" data-bs-placement="top" title="Editar tipo">
                        ...
                        <form class="btn btn-sm delete-type" method="POST"
                            ...
                            <a class="btn btn-light btn-sm rounded shadow-sm border delete"
                                ...
                                data-bs-placement="top" title="Eliminar tipo">
    ...
    $(document).on('click', '.delete', function() {
        ...
        swalWithBootstrapButtons.fire({
            title: '¿Estás seguro?',
            text: "El tipo será eliminado, ¡No podrás revertir esto!",
            icon: 'warning',
        ...
        $('#main-modal .modal-title').text('Crear nuevo tipo')
        ...
        $('#main-modal .modal-title').text('Editar tipo')
        $('#main-modal .modal-body').html(response.view)
        $('.select2').select2();
