...
@section('title', 'Elegir Habitación para Reserva')
@section('head')
            ...
            <div class="col-md-8 mt-2">
                <div class="card shadow-sm border">
                    <div class="card-body p-3">
                        <h2>{{ $roomsCount }} Habitaciones Disponibles para:</h2>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-select" id="sort_name" name="sort_name"
                                        ...
                                        <option value="Number" @if (request()->input('sort_name') == 'Number') selected @endif>Número</option>
                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div
                                        ...
                                        <div class="col p-4 d-flex flex-column position-static">
                                            <strong class="d-inline-block mb-2 text-secondary">{{ $room->capacity }} {{ Str::plural('Persona', $room->capacity) }}</strong>
                                            <h3 class="mb-0">{{ $room->number }} ~ {{ $room->type->name }}</h3>
                                            <div class="mb-1 text-muted">{{ Helper::convertToRupiah($room->price) }} / Día</div>
                                            <div class="wrapper">
                            ...
                            @empty
                                <h3>No hay habitaciones disponibles para {{ request()->input('count_person') }} o más
                                    personas
                                </h3>
                            @endforelse
                        </div>
