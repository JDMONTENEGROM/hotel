                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mt-2">
                                <form method="POST"
                                    ...
                                    <div class="row mb-3">
                                        <label for="how_long" class="col-sm-2 col-form-label">Total de días</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="how_long" name="how_long"
                                                placeholder="col-form-label"
                                                value="{{ $dayDifference }} {{ Helper::plural('Día', $dayDifference) }} "
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <label for="minimum_dp" class="col-sm-2 col-form-label">Anticipo mínimo</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"
                                                ...
                                                id="downPayment" name="downPayment" placeholder="Ingrese el pago aquí"
                                    ...
                                    <button type="submit" class="btn btn-primary float-end">Pagar Anticipo</button>
                                </form>
                            </div>
                        </div>
                    </div>
