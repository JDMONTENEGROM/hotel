            ...
            <div class="col-lg-9 mt-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <label class=" col-sm-2 col-form-label">Precio de Habitación</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Número de Días</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form method="POST"
                                    ...
                                    @csrf
                                    <div class="row mb-3">
                                        <label for="payment" class="col-sm-2 col-form-label">Pagar</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('payment') is-invalid @enderror"
                                                placeholder="Ingrese el pago" value="" id="payment" name="payment">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
