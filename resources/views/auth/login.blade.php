    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <h4 class="mb-2 fw-bold">Hotel Real</h4>
                <p class="mb-0 opacity-75">¡Bienvenido de nuevo! Por favor inicia sesión para continuar.</p>
            </div>
            ...
            <div class="login-body">
                ...
                <div class="demo-info">
                    <h6><i class="fas fa-info-circle me-2"></i>Cuenta de Demostración</h6>
                    <p><strong>Email:</strong> wailantirajoh@gmail.com</p>
                    <p><strong>Contraseña:</strong> wailan</p>
                </div>
            </div>
        </div>
    </div>
