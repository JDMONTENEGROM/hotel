                ...
                <div class="col-lg-6 mb-2">
                    <div class="d-grid gap-2 d-md-block">
                        <a href="{{ route('user.create') }}" class="btn btn-sm shadow-sm myBtn border rounded"
                            data-bs-toggle="tooltip" data-bs-placement="right" title="Agregar Usuario">
                ...
                <div class="col-lg-6 mb-2">
                    <form class="d-flex" method="GET" action="{{ route('user.index') }}">
                        ...
                        <select class="form-select me-2" name="status" style="max-width: 150px;">
                            ...
                            <option value="inactive" {{ request()->input('status') == 'inactive' ? 'selected' : '' }}>Inactivos</option>
                        </select>
                        <input class="form-control me-2" type="search" placeholder="Buscar por correo" aria-label="Buscar"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-light btn-sm rounded shadow-sm border p-0 m-0"
                                                        ...
                                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Detalle del Usuario">
                                                        <svg width="25" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6"
                                                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-light btn-sm rounded shadow-sm border p-0 m-0 disabled"
                                                        ...
                                                        data-bs-placement="top" title="Detalle del Usuario">
                                                        <svg width="25" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6"
                                                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
    ...
    <script>
        $('.delete').click(function() {
            ...
            swalWithBootstrapButtons.fire({
                title: '¿Estás seguro?',
                text: user_name + ' será eliminado. ¡No podrás revertir esta acción!',
                icon: 'warning',
