                        ...
                        <table class="table table-borderless">
                            <tbody>
                                <tr class="add">
                                    ...
                                    <td class="text-center">Precio de habitación / día</td>
                    ...
                    <div class="products p-2">
                        <table class="table table-borderless">
                            <tbody>
                                <tr class="add">
                                    <td></td>
                                    <td class="text-center">Anticipo mínimo</td>
                    ...
                    <div class="address p-2">
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr class="content">
                                    <td>
                                        ID del cliente : {{ $payment->transaction->customer->id }}
                                        <br>Nombre del cliente : {{ $payment->transaction->customer->name }}
                                        <br> Profesión del cliente : {{ $payment->transaction->customer->job }}
